...
const friends = {
  '2025-2': [
    ...
    },
    {
      id: 2,
      name: 'Ana',
      imageUrl: 'https://cdn.pixabay.com/photo/2014/04/03/10/44/avatar-311292_960_720.png'
    }
  ],
  '2026-1': [
    {
...
const hiddenUsersCount = computed(() =>
  friends[period.value]?.length > maxVisible ? friends[period.value].length - maxVisible : 0
)

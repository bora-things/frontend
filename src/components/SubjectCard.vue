          ...
          >
            ...
            <div>
              <img
                ...
                alt="Foto do amigo"
              />
              <div v-else class="w-10 h-10 rounded-full flex items-center justify-center bg-bp_grayscale-600">
        ...
        <div class="flex gap-2">
          <span
            :class="[
              ...
              type === 'Obrigatória' ? 'border-bp_green-600' : 'border-sky-600',
            ]"
          >
            {{ type === 'Obrigatória' ? "OBRIGATÓRIO" : "OPTATIVO" }}
          </span>
          <span
            class="font-sans badge border-bp_grayscale-500 flex items-center justify-center bg-transparent border text-vtd-secondary-100"
          >
